                ...
                <el-row class="rows">
                    ...
                    <el-col :span="6"> 
                        <el-form-item :span="6" label="出生日期" prop="birthday">
                            <el-date-picker v-model="addUser.birthday" type="date" value-format="yyyy/MM/dd" placeholder="出生日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item :span="6" label="职业身份" prop="work_type">   
                            <el-select v-model="addUser.work_type" placeholder="职业身份">
                                ...
                                <el-option value="101">党政军干部</el-option>
                ...
                <el-form-item v-for="(relaCust, index) in addUser.relaCusts" >
                    <el-row :gutter="20">
                        ...
                        <el-select v-model="relaCust.rela_type1" placeholder="关系类型1">
                            <el-option value="1">家人</el-option>
                            <el-option value="3">保姆</el-option>
                            <el-option value="2">租户</el-option>
                            <el-option value="4">暂住</el-option>
                        </el-select>
                        </el-col>
                        <el-col :span="4" style="padding-bottom: 0px;">
                        <el-select v-model="relaCust.rela_type2" placeholder="关系类型2">
                            <el-option value="28001 ">夫妻</el-option>
                            <el-option value="28002 ">子女</el-option>
                            <el-option value="28003 ">亲戚</el-option>
                        </el-select>
                        </el-col>
                        <el-col :span="4" style="padding-bottom: 0px;">
...
export default {
  ...
  methods: {
    ...
    getRecust() {
      this.$http({
        method: "post",
        url: "cust/company/relation/detail",
        data: {
          cust_id: this.$route.query.cust_id
        },
        headers: {
