<template>
    <section class="bg">
        ...
        <el-form :inline="true" :model="{needUser}" ref="needUser">
            <el-col class="toolbar" v-for="item in needUser">
                ...
                <el-row :gutter="50">
                    ...
                    <el-col :span="6" style="padding-bottom: 0px;">
                        <label>最关注因素:</label>
                        <span>{{item.favorite_bc}}</span>
                    </el-col> 
                    <el-col :span="6" style="padding-bottom: 0px;">
                        <label>来访次数:</label>
                        <span>{{item.visiting_times}}</span>
                    </el-col>
                    <el-col :span="6" style="padding-bottom: 0px;">   
                        <label>认知媒体大类:</label>
                        <span>{{item.media_big}}</span>
                    </el-col>
                </el-row>
                <el-row :gutter="50">
                    <el-col :span="6" style="padding-bottom: 0px;">   
                        <label>认知媒体子类:</label>
                        <span>{{item.media_small}}</span>
                    </el-col>
                    <el-col :span="6" style="padding-bottom: 0px;">
                        <label>来源渠道:</label>
                        <span>{{item.cognitive_approach}}</span>
                    </el-col> 
                </el-row>
                <el-row>
...
export default {
      ...
      needUser: [
        {
          ...
          favorite: "", // 最关注方面
          favorite_bc: "", // 最关注因素
          visiting_times: 0, // 来访次数
          media_big: "", // 媒体大类
          media_small: "", // 媒体子类
          cognitive_approach: "" // 来源渠道
        }
      ],
      followUser: []
    };
  ...
  mounted() {
    ...
    this.$http({
      ...
      data: {
        cust_id: this.$route.query.cust_id,
        intention_id: this.item.intention_id
      },
      headers: {
        sign: localStorage.getItem("sign")
      }
